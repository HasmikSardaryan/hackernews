...
const Header = () => {
    ...
    <Link to=""> 
        <img style={{ border: 'solid white' }} src="https://news.ycombinator.com/y18.svg" alt="" />
    </Link>
    ...
    <Link to="/past" className="router">past</Link>|
        <Link to="/login" className="router">comments</Link>|
        ...
        <span className="login">
            {user ? (
                <Link to="/logout" className="router">logout</Link>
            ) : (
